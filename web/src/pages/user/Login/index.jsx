...
const LoginMessage = ({content}) => (<Alert
  style={{
    marginBottom: 24,
  }}
  message={content}
  ...
  return (<div className={styles.container}>
    <div className={styles.content}>
      <LoginForm
        ...
        subTitle='本工具可以帮助构建图片数据库，提供便捷的以图搜图服务'
        initialValues={{
          autoLogin: true,
        }}
        actions={[]}
      ...
      >
        ...
        {type === 'account' && (<>
          <ProFormText
            name="name"
            fieldProps={{
              size: 'large', prefix: <UserOutlined className={styles.prefixIcon}/>,
            }}
            placeholder='请输入账号'
            rules={[{
          ...
          <ProFormText.Password
            name="password"
            fieldProps={{
              size: 'large', prefix: <LockOutlined className={styles.prefixIcon}/>,
            }}
            placeholder='请输入密码'
            rules={[{
